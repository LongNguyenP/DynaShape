...
public class KdTree
{
    ...
    public List<int> Search(float centerX, float centerY, float centerZ, float radius)
    {
        ...
        SearchRecursively(0, nodes.Length - 1, centerX, centerY, centerZ, radius, result);
        return result;
    }
        ...
        List<int> results)
    {
        ...
        {
            if (s <= m - 1) SearchRecursively(s, m - 1, centerX, centerY, centerZ, radius, results);
        }
        ...
        if (splitter == 0 && centerX + radius > nodeX ||
            ...
            splitter == 2 && centerZ + radius > nodeZ)
        {
            if (m + 1 <= e) SearchRecursively(m + 1, e, centerX, centerY, centerZ, radius, results);
        }
    }
