...
namespace DynaShape.Goals
{
    ...
    public class ShapeMatchingGoal : Goal
    {
        ...
        private void Initialize(List<Triple> nodeStartingPositions, List<Triple> targetShapePositions, bool allowScaling, float weight)
        {
            Weight = weight;
        ...
        {
            // Here we compute the "best" translation & rotation (and optionally scaling) that bring the targetShapePoints as close as possible to the current node positions
            // Reference: Umeyama S. 1991, Least-Squares Estimation of Transformation Parameters Between Two Point Patterns
            ...
            //=====================================================================
            // Mean Centering
            // i.e. Subtract the current center from the current positions ...
            //=====================================================================
